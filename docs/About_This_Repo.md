...
│   ├── scripts/    # Examples of running model from Python script
│   └── cli/        # Examples of running model from cli + json files.
...
### 1. Asset projection
   ...
   - Run from Python script:
      ...
      ```
   - Run from cli + json file (`.\examples\cli\model_args_01.json`)
      ```powershell
      .\examples\cli\cli_01.bat
      ```
   - Standard output (`.proj.csv`): `.\examples\results\script_01_asset_proj\`, `.\examples\results\cli_01_asset_proj\`
...
### 2. Fund projection
   ...
   - Run from Python script:
      ...
      ```
   - Run from cli + json file (`.\examples\cli\model_args_02.json`)
      ```powershell
      .\examples\cli\cli_02.bat
      ```
   - Standard output (`.proj.csv`): `.\examples\results\script_02_fund_proj\`, `.\examples\results\cli_02_fund_proj\`
...
### 3. C-ROSS projection
   ...
   - Run from Python script:
      ...
      ```
   - Run from cli + json file (`.\examples\cli\model_args_03.json`)
      ```powershell
      .\examples\cli\cli_03.bat
      ```
   - Standard output (`.proj.csv`): `.\examples\results\script_03_cross_proj\`, `.\examples\results\cli_03_cross_proj\`
...
### 4. Monte Carlo simulation (stochastic)
   ...
   - Run from Python script:
      ...
      ```
   - Run from cli + json file (`.\examples\cli\model_args_11.json`)
      ```powershell
      .\examples\cli\cli_11.bat
      ```
   - Standard output (`.proj.csv`, `.stoch.csv`, `.stoch.statistic.csv`): `.\examples\results\script_11_monte_carlo\`, `.\examples\results\cli_11_monte_carlo\`
...
### 5. Smith-Wilson curve
   ...
   - Run from Python script:
      ...
      ```
   - Run from cli + json file (`.\examples\cli\model_args_21.json`)
      ```powershell
